...
public class MonsterPrefabTable : ScriptableObject
{
    [System.Serializable]
    public struct Entry
    {
    ...
    public GameObject GetByName(string spriteName)
    {
        BuildLookupIfNeeded();
    ...
    private void BuildLookupIfNeeded()
    {
        ...
        {
            if (string.IsNullOrEmpty(e.Name) || e.Prefab == null) continue;
            if (!_lookup.ContainsKey(e.Name))
                _lookup[e.Name] = e.Prefab;
            else
